...
import 'package:apk_masjid/pages/auth/nbl_remas.dart';
import 'package:apk_masjid/pages/auth/nbl_takmir.dart';
...
List<CndyCategoryModel> cats = [
  ...
  CndyCategoryModel(icon: Icons.person, title: "Takmir Masjid", color: Colors.green, page: NblTakmir()),
  CndyCategoryModel(icon: Icons.perm_identity_rounded, title: "Remaja Masjid", color: Colors.green, page: NblRemas()),
